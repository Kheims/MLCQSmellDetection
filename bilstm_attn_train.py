...
import json
import logging
from simple_model import SimpleLSTM, SimpleLSTMConfig, SimpleBILSTM, SimpleBILSTMAttn
...
def main():
    ...
    model = SimpleBILSTMAttn(model_config).to(device)
    logging.info(f"\nModel Architecture:\n{model}")
